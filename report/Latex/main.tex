...
\begin{figure}[H]
    ...
    \caption{RMSE vs.\ fractional bits of Scaling Factor ($1/K$).}
    \label{fig:rmse-k-inv-frac}
\end{figure}
...
\section{Bit-True Model Verification}

We evaluate the bit-true model on all 11 patterns in \texttt{Final11Pattern.mat} with $B = 11$, $N_{\mathrm{stage}} = 8$, $\mathrm{MAX\_ITER} = 7$ and $ (1/K)= 16$.
...
% ─────────────────────────────────────────────
\chapter{Section 2: Hardware Architecture and Control}
% ─────────────────────────────────────────────
...
% ─────────────────────────────────────────────
\chapter{Section 3: Hardware Simulation}
% ─────────────────────────────────────────────
...
\texttt{OutValid}.
As shown in the waveforms, one complete EVD run finishes in \textbf{112 clock cycles (M)},
...
We run gate-level simulation at the best-ATP from section 6, whose clock period $T_s$
...
% ─────────────────────────────────────────────
\chapter{Section 4: Area-Time Product}
...
\chapter{Section 5: Design Innovations}
...
% ─────────────────────────────────────────────
\chapter{Section 6: Team Contributions}
% ─────────────────────────────────────────────
...
\chapter{Synthesis Reports for Best ATP Configuration}
\endgroup

\section{Timing Report}

\begin{center}
    \includegraphics[width=0.8\linewidth,height=0.92\textheight,keepaspectratio]{report1.png}
    \captionof{figure}{Critical-path timing report (max delay), part~1.}
    \label{fig:timing-report-1}
\end{center}

\begin{center}
    \includegraphics[width=0.8\linewidth,height=0.92\textheight,keepaspectratio]{report2.png}
    \captionof{figure}{Critical-path timing report (max delay), part~2. Slack is
    \SI{0.00}{ns} (MET).}
    \label{fig:timing-report-2}
\end{center}

\section{Area Report}

\begin{center}
    \includegraphics[width=\linewidth]{report3.jpg}
    \captionof{figure}{Post-synthesis area report.}
